export const cpx = {
  ...
  application: {
    title: "적용 분야",
    description: "ChemPro-X는 다용도 화학 탐지기로, 휴대용 장비로 사용하거나 현장 배치 네트워크의 원격 구성 요소로 활용할 수 있습니다. ChemPro-X의 화학 탐지 성능은 다양한 적용 분야에서 입증되었습니다. 예를 들어, 단독 사용(일반 화학 탐지기로 사용), 그룹 사용, 경계 모니터링 네트워크, 무인 지상/항공 차량 등에서 활용됩니다.",
    items: [
      "긴급 대응팀",
      "군사 작전",
      "드론 탑재",
