export const solution = {
  ...
  electronicWarfare: {
    ...
    title: "전자기전",
    summary:
      "적 통신, 레이더, 드론 신호를 수집하고 출처를 찾아 무력화합니다.",
  },
  nuclearChemical: {
    label: "NC",
    title: "화학/방사능 탐지",
  ...
  cuasPage: {
    ...
    capabilities: {
      ...
      items: [
        {
          name: "탐지 및 추적",
          description: "작전 공역 전반에 걸친 무인 항공 시스템의 다중 센서 탐지·추적 및 실시간 위협 식별·분류",
        },
        {
          name: "재밍 및 무력화 ",
          description: "탐지 연동 자동 재밍으로 드론 조종·영상·항법 신호를 동시 차단하여 위협을 즉각 무력화",
        },
